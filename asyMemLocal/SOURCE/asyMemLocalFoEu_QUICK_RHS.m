%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function:    asyMemLocalFoEu_QUICK_RHS(phiFeed,localCompFlux,fugFeed    %
%                ,params)                                                 %
% Description: RHS function for QUICK shooting algorithm of asyMem.        %
...
function   [funRHS] = asyMemLocalFoEu_QUICK_RHS(phiFeed,localCompFlux,fugFeed,params)
...
%IVP solve
    ...
    if params.memPhaseModel == 1 
      %manual discritization IVP solve
        [z,stateVars,~] = asyMemLocalSA_IVP_TimeStep(phiFeed,fugFeed,localCompFlux,params);
        phiFinal = stateVars(end,1:n+1).';
        [params.chis,params.diffs] = correlationEval(phiFinal,diffs,chis,params);
        ypFinal = phis2yPhaseEq_FH_RHS(phiFinal,params);% FH based
        
    elseif params.memPhaseModel == 2 || params.memPhaseModel == 3
      %manual discritization IVP solve
        [z,~,fugFinal] = asyMemLocalSA_IVP_TimeStep(phiFeed,fugFeed,localCompFlux,params);

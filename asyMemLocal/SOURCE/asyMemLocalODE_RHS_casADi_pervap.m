...
function [odeRHS] = asyMemLocalODE_RHS_casADi_pervap(odeState,algState,solverState,params)
...
[B,invGam] = matrixEvalGammaB_FH_LM_casADi(stateVec,params,solverState);
    odeRHS(1:n) = -invGam*B*localCompFlux(1:n)*1000/3600; %note correct convertsion from LMH to UM3/UM2/s
